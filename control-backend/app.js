...
// const authRoutes = require('./routes/authRoutes'); // Eliminado
const softwareRoutes = require('./routes/softwareRoutes');
const celularRoutes = require('./routes/celularRoutes');
const auxiliaresRoutes = require('./routes/auxiliaresRoutes'); // Ruta correcta
const { Software } = require('./models/Software'); // Asegúrate de que este modelo esté correcto
...
// Middleware para registrar las rutas solicitadas (opcional pero útil para depuración)
...
// app.use('/api/auth', authRoutes); // Eliminado
app.use('/api/software', softwareRoutes);
app.use('/api/celulares', celularRoutes);
app.use('/api/auxiliares', auxiliaresRoutes); // Rutas de auxiliares
...
// Ejecuta la función de notificación cada hora (3600000 ms)
setInterval(notifyExpiringSoftware, 3600000);
